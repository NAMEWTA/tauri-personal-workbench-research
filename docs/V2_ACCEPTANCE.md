...
| sidecar loopback、SQLite、优雅关闭 | `pnpm test:sidecar` | 通过（0.2.12，2026-09-05） |
...
| macOS sidecar、app、DMG | CI native/bundle artifacts | 待 CI workflow |
...
- 发布提交：`eba6aac`；v0.2.12 workflow 与 Release 链接将在 CI 成功后补充。
