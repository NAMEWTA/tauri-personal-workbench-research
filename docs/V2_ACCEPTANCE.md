...
| Windows 安装包与实际 WebView2 操作 | `scripts/smoke-installed.ps1` | 通过（三种 schema 2 启动场景，2026-09-06） |
| Windows portable ZIP | 解压后运行 `native-workspace-smoke.mjs` | 通过（Windows，2026-09-06） |
| macOS sidecar、app、DMG | CI native/bundle artifacts | 通过（workflow 34006715673，2026-09-06） |
| 生成代码无漂移 | `pnpm generate` + deterministic rerun | 通过（2026-09-06） |
