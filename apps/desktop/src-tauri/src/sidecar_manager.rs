...
mod tests {
    ...
    fn parses_valid_ready_line() {
        let ready = parse_ready_line(
            br#"{"type":"ready","protocolVersion":3,"port":49152,"pid":42,"origin":"http://127.0.0.1:49152","workspaceId":"workspace","serviceVersion":"0.2.13"}"#,
        )
        .expect("ready line should parse");
        assert_eq!(ready.port, 49152);
        assert_eq!(ready.service_version, "0.2.13");
    }
